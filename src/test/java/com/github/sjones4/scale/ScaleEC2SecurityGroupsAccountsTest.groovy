...
/**
 * Scale test for EC2 security groups.
 *
 * https://eucalyptus.atlassian.net/browse/EUCA-11097
 */
class ScaleEC2SecurityGroupsAccountsTest {
  ...
  void test( ) {
    ...
    try {
      ...
      print( "Creating ${groups} security groups in ${accounts} accounts using ${threads} threads" )

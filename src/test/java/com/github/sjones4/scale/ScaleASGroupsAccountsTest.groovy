...
/**
 * Scale test for auto scaling groups in multiple accounts.
 *
 * https://eucalyptus.atlassian.net/browse/EUCA-11125
 */
class ScaleASGroupsAccountsTest {

  private final AWSCredentialsProvider eucalyptusCredentials

  ScaleASGroupsAccountsTest( ) {
  ...
  void test( ) {
    ...
    try {
      ...
      print( "Creating ${groups} auto scaling groups in ${accounts} accounts ${threads} threads" )
      ...
      print( "Created ${accounts*groups} auto scaling groups, describing." )
